...
#[derive(Debug, Clone)]
pub struct FreeTotpEntry {
    pub id: Option<Uuid>,
    pub name: String,
    pub totp: TOTP,
}

impl TryFrom<Entry> for FreeTotpEntry {
...
pub fn update_free_totp_entry_in_keepass(value: FreeTotpEntry, entry: &mut EntryMut) {
    entry
        .fields
...
// impl From<FreeTotpEntry> for Entry {
