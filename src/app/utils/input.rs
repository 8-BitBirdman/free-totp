...
use crate::app::core::FreeTotpEntry;
use anywho::anywho;
...
#[derive(Debug, Clone)]
pub struct InputableFreeTotpEntry {
...
impl Default for InputableFreeTotpEntry {
    fn default() -> Self {
        Self {
...
impl From<FreeTotpEntry> for InputableFreeTotpEntry {
    fn from(value: FreeTotpEntry) -> Self {
        Self {
            uuid: value.id,
            name: value.name,
...
impl TryFrom<InputableFreeTotpEntry> for FreeTotpEntry {
    type Error = anywho::Error;

    fn try_from(value: InputableFreeTotpEntry) -> Result<Self, anywho::Error> {
        let secret = value
            .secret
            .chars()
